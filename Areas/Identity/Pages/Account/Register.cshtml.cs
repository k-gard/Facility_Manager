...
namespace FacilityManager.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async System.Threading.Tasks.Task OnGetAsync(string returnUrl = null)
        {
            ...
            foreach (Department d in _context.Department.ToList())
            {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                Department department =  _context.Department.Find(Input.Department);
                ...
                if (result.Succeeded)
                {
                   await _userManager.AddToRolesAsync(user, new List<string>() { user.EmployeeType });
